...
public class cross_log_pred_avg_voting_top5_avg_all_pair
{
...
String result_table = "cross_log_pred_avg_voting_all_pair_rq4_"+type+"_best_10";
...
{	  	
	  ...
	  cross_log_pred_avg_voting_top5_avg_all_pair clps =  new cross_log_pred_avg_voting_top5_avg_all_pair();
