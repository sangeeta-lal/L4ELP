...
public class cross_log_pred_avg_voting_1_itr
{
...
String result_file =  path+"L4ELP\\result\\avg_vote_result_1_itr.txt";
...
String result_table = "cross_log_pred_avg_voting_"+type+"_1_itr";
...
{	  	
	  ...
	  cross_log_pred_avg_voting_1_itr clps =  new cross_log_pred_avg_voting_1_itr();
