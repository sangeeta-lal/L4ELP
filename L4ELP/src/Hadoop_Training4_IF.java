...
public class Hadoop_Training4_IF
{
    ...
    String non_logged_file_path = "F:\\Research\\L4ELP\\result\\hd_non_log_if.txt";
	String logged_file_path = "F:\\Research\\L4ELP\\result\\hd_log_if.txt";
    ...
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L4ELP\\result\\hd_non_log_if.txt";
	String logged_file_path = "E:\\Sangeeta\\Research\\L4ELP\\result\\hd_log_if.txt";
   ...
   //*/
	...
	{				    
		Hadoop_Training4_IF demo = new Hadoop_Training4_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Hadoop_Training4_IF.readFileToString(file_name);
