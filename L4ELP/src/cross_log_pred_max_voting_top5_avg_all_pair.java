 ...
 * 3.  This file have used results from the table ""
 * 4. This file have computed for each majority ensemble technique  all the parameters, f-measure, accuracy, etc.
 * 
 5. I have manually identified for each majorityVote algorithm average on all source->target pairs
 6. I then identify top-5 of them and run then to 10 iteration using the file " cross_log_pred_max_voting_top5_avg_all_pair_10_itr.java".

 * 
 */

public class cross_log_pred_max_voting_top5_avg_all_pair
{
...
String result_table = "cross_log_pred_max_voting_all_pair_rq4_"+type+"_best_10";
...
{	  	
	  ...
	  cross_log_pred_max_voting_top5_avg_all_pair clps =  new cross_log_pred_max_voting_top5_avg_all_pair();
